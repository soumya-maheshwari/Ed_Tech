...
const Categories = () => {
  ...
  return (
    <div className=' hero1 flex justify-center items-center pt-10' style={{
      ...
      <div className='z-10'>
        ...
        <div className="flex flex-wrap justify-center">
          {Courses.map(course => (
            <div className="col-md-4 m-10 sm:col-6 md:col-4 lg:col-4 flex justify-center items-center" key={course.name}>
              <div className="bg-white rounded-full flex flex-col items-center justify-center w-80 max-w-full card-container">
