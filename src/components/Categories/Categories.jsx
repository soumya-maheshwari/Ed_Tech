...
const Categories = () => {
  return (
    <div
      className=" hero1 gradient flex justify-center items-center"
      style={{
    ...
    >
      <div className="z-10">
        <h2
          style={{ fontFamily: "Gill sans, Georgia" }}
          className="text-center text-4xl font-bold  my-10 text-white"
        >
        ...
        <div className="flex flex-wrap justify-center">
          ...
          <NavLink to="/arts">
            <div className="col-md-4 m-10 sm:col-6 md:col-4 lg:col-3 xl:col-3 flex flex-col justify-center items-center">
              ...
              <div className="text-center p-5 text-white">
                <h5 className="card-title ">India and Tradition</h5>
              </div>
            </div>
          </NavLink>
        </div>
