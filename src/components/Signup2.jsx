        ...
        <div className=''>
            <div className='block md:flex'>
                <div className="flex w-full bg-no-repeat bg-cover" style={{
                    ...
                    <div className='h-[40rem] flex justify-center items-center text-white  p-4 bg-no-repeat bg-cover my-12'>
                ...
                <div className="w-full h-[40rem] flex justify-center items-center">
                    <div className='h-[30rem]'>
                        <div className='p-4 my-12'>
                            <h1 className='text-4xl font-extrabold text-black text-center '>Create New Account!!</h1>
                            <div className='p-8'>
                                ...
                                <input type="text" placeholder="Enter phone number" className="input input-bordered w-full mt-6 bg-white"/>
                            </div>
                            <div className='text-center my-6'>
                                <div className='btn bg-primary hover:bg-white text-white border-primary hover:text-primary hover:border-primary text-center shadow-gray-300 shadow-md hover:shadow-2xl'>Sign Up</div>
                            </div>
